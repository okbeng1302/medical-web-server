...
public class NewsCategoryController {
    ...
    public String newsCategoryManage(NewsCategory newsCategory, @PathVariable Integer pageCurrent,
        ...
        String pageHTML = PageUtil.getPageContent(
                "newsCategoryManage_{pageCurrent}_{pageSize}_{pageCount}?name=" + newsCategory.getName(), pageCurrent,
                pageSize, pageCount);
    ...
    public String newsCategoryEditPost(Model model, NewsCategory newsCategory, @RequestParam MultipartFile[] imageFile,
