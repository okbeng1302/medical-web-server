...
import com.medical.dao.NewsCategoryService;
import com.medical.dao.NewsService;
...
public class NewsController {
    ...
    public String newsManage(News news, @PathVariable Integer pageCurrent, @PathVariable Integer pageSize,
        ...
        String pageHTML = PageUtil.getPageContent("newsManage_{pageCurrent}_{pageSize}_{pageCount}?title="
                + news.getTitle() + "&category=" + news.getCategory() + "&commendState=" + news.getCommendState()
                + "&orderBy=" + news.getOrderBy(), pageCurrent, pageSize, pageCount);
    ...
    public String newsEditPost(Model model, News news, @RequestParam MultipartFile[] imageFile,
        ...
        for (MultipartFile file : imageFile) {
            if (file.isEmpty()) {
                ...
                String fileName = strDate + "_" + random.nextInt(1000) + file.getOriginalFilename()
